...
class HandlerTest extends Specification with BeforeEach with AfterEach {
  ...
  "algorithm execution" should {
    "With successful primitive string IO" in {
    ...
    "With Custom case class I/O, with loading" in {
    ...
    "With failure during loading" in {
      val input = """{"content_type":"text","data":"algorithmia"}"""
      val expected = Json.parse(
        """{"error":{"message":"Exception: This is an expected failure state","error_type":"class java.lang.Exception"}}"""
      )
    ...
    "With failure during runtime, with stdout loader" in {
      val input = """{"content_type":"text","data":"algorithmia"}"""
      val expected = Json.parse(
        """{"error":{"message":"Exception: This is another expected failure state","error_type":"class java.lang.Exception"}}"""
      )
    ...
    "With multiple basic requests" in {
      val input = """{"content_type":"text","data":"algorithmia"}"""
